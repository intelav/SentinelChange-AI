...
data = dict(
    ...
    test=dict(
        ...
        #type='PreCachedXview2BuildingLoader',
        params=dict(
            root_dir=('/media/avaish/aiwork/satellite-work/datasets/LEVIR-CD/train',
                      '/media/avaish/aiwork/satellite-work/datasets/LEVIR-CD/val',
                      '/media/avaish/aiwork/satellite-work/datasets/LEVIR-CD/test'),
...
train['num_iters'] = 40000 # Set to approximately 1 hour of training
